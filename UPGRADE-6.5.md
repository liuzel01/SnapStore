...
With [NEXT-25804](https://issues.snapadmin.net/issues/NEXT-25804) we fixed an issue with duplicated theme images on `system:update` and `theme:refresh`.
...
1. attribute `parent` for element `module` will be required.
   ...
   like described in [our documentation](https://developer.snapadmin.net/docs/guides/plugins/apps/administration/add-custom-modules)
