...
class EmailRuleTest extends TestCase
{
    ...
    public static function getMatchValues(): \Traversable
    {
        ...
        yield 'operator_eq / not match partially start / email' => [Rule::OPERATOR_EQ, 'test@example.com', '*@snapadmin.net', false];
        ...
        yield 'operator_neq / not match partially start / email' => [Rule::OPERATOR_NEQ, 'test@example.com', '*@snapadmin.net', true];
