...
class EntityWriterTest extends TestCase
{
        ...
        $this->getWriter()->insert(
            ...
            [
                [
                    ...
                    'tax' => ['name' => 'test', 'taxRate' => 5],
                    'manufacturer' => ['id' => Uuid::randomHex(), 'link' => 'https://snapadmin.net', 'name' => 'shopware AG'],
                    'mode' => 0,
                    'lastStock' => true,
                    'crossbundlelook' => 1,
                    'notification' => true,
    ...
    public function testUpdate(): void
    {
        ...
        static::assertSame('http://www.snapadmin.net', $productManufacturer['link']);
    }
